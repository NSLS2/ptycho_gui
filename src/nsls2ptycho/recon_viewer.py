...
def scale_window(window, scale_factor):
    ...
    window.setGeometry(geometry.x(), geometry.y(),
                       ...
                       int(geometry.height() * scale_factor))
    window.centralWidget().setFixedSize(int(geometry.width()),int(geometry.height()))
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        live_path = '/nsls2/data2/hxn/legacy/users/2025Q3/Lu_2025Q3/ptycho_zg/remote_orion_zgao1' 
